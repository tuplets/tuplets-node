...
__export(index_exports, {
  ...
  TupletsClient: () => TupletsClient,
  TupletsError: () => TupletsError,
...
var JobsResource = class {
  ...
  async createFromFile(filePath, params = {}, contentType) {
    ...
    return this.createFromBytes((0, import_node_path.basename)(filePath), data, params, contentType);
  }
...
var UploadsResource = class {
  ...
  async uploadFile(target, filePath, contentType) {
    ...
    await this.uploadBytes(
      target,
      data,
      contentType ?? guessContentType((0, import_node_path2.basename)(filePath))
    );
  }
